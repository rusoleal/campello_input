...
`campello_input` is a cross-platform C++17 game input library (version 0.1.0). It abstracts platform-specific input APIs behind a unified interface in the `systems::leal::campello_input` namespace. The project is in early development.
